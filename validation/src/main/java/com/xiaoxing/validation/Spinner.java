...
import com.xiaoxing.validation.adapter.ProxySpinnerAdapter;
...
public class Spinner extends AbstractValidateableView<android.widget.Spinner, Object> {
     ...
     * to {@link ViewGroup.LayoutParams#MATCH_PARENT} to match the width of the Spinner
     * itself, or {@link ViewGroup.LayoutParams#WRAP_CONTENT} to wrap to the measured
     ...
     * value may also be {@link ViewGroup.LayoutParams#MATCH_PARENT} meaning the popup
     * window will match the width of the Spinner itself, or {@link ViewGroup.LayoutParams#WRAP_CONTENT}
