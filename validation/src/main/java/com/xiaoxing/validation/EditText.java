...
public class EditText extends AbstractValidateableView<android.widget.EditText, CharSequence> {
    ...
    /**
     * Gets the autolink mask of the text. See {@link Linkify#ALL Linkify.ALL} and
    ...
    /**
     * Sets the autolink mask of the text. See {@link Linkify#ALL Linkify.ALL} and
     * peers for possible values.
     */
     ...
     * TruncateAt#END} and {@link TruncateAt#MARQUEE}
     * are supported (other ellipsizing types will not do anything).
     */
    public final void setEllipsize(final TruncateAt where) {
    ...
    /**
     * Like {@link #setText(CharSequence, BufferType)}, except that the
